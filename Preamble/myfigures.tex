...
\newcommand{\figPossiblePreferences}{\begin{figure}[tbp]
 \begin{center}
 	\includegraphics[width=6in]{PossPrefs2}%{PossiblePreferences}
	 \caption{Theoretical Preference Functions of Officers over Potential Assignments}
     \label{fig:possPref}
  \end{center}
 \end{figure}
 }
